...
def main(page: ft.Page):
    ...
    upload_status = Text("")
    status_button = ElevatedButton(text="file status", on_click= '')
    ...
    page.add(
        Column([
            ...
            Column([username_field, authenticate_button]),
            status_text,
            Column([select_folder_button, selected_folder_text]),
            Column([repo_name_field, add_folder_button]),
